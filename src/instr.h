...
Запрос для записи действия пользователя:https://api.steklm.ru:51112/api/log/
URL - http://192.168.0.26:1322/api/log/ (post, авторизация нужна)
В тело запроса поместить данные в следующем формате://{"Card":"","Mac":"3C:84:27:20:F5:8C","Date":"25.11.2024","Cell":"tool_1","isHere":"false"}
{
    "Card": "number",
    "Mac": "mac",
    "Cell": "cell",
